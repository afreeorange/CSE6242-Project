...
class WorldMap extends Graphic {
  ...
  constructor(elemName, params = {}) {
    ...
    if (this.data == "none" || this.topo == "none") this.missingParams = true;
  ...
  setMapProjection() {
    ...
    var projection = d3
      ...
      .translate([this.width / 2, this.width / 4]);
  ...
  drawCountryBorders() {
    ...
    this.map
      ...
      .datum(
        topojson.mesh(this.topo, this.topo.objects.countries, function(a, b) {
          return a !== b;
        }),
      )
      .attr("d", this.mapPath);
  ...
  fillCountryValues() {
    ...
    var mouseover = function(d) {
      ...
      if (wsiVal == undefined) wsiVal = "Data Unavailable";
      tip
        .html(
          "<center><b>" +
            d.properties.name +
  ...
  drawLegend() {
    ...
    // Set the location
    this.legend.attr("transform", `translate(${this.width - 100}, 20)`);
