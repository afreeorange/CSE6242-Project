...
class Timeline extends Graphic {
  ...
  */
  constructor(elemName, params={}) {
    ...
    if ( this.years == 'none' || this.year == 'none' )
  ...
  drawTimeline() {
    ...
    this.timeline
      ...
      .enter()
        ...
        .attr("class", function(d) {
          if(d < 2015)
            return "timeline-line historical";
          else
            return "timeline-line forecast";
        })
        .attr("x", function(d,i) {
        ...
        .append("circle")
          .attr("class", function(d) {
            if(d == yr && d < 2020)
              ...
              return "timeline-years historical";
            else if(d == yr)
              return "timeline-years forecast selected-year";
            else
              return "timeline-years forecast";
          })
    ...
    this.timeline
      ...
      .enter()
        ...
        .attr("class", function(d){
          if(d < 2020)
            return "time-label historical";
          else
            return "time-label forecast";
        })
        .attr("x", function(d,i) { return i*width/years.length + width/(3*years.length); })
        .attr("y", 30)
